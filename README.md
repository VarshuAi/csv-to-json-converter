...
1. **Clone the repository:**
   ```bash
   git clone https://github.com/VARSHAN69/csv-to-json-converter.git
   cd csv-to-json-converter
   ```
...
[![Repo](https://img.shields.io/badge/csv-to-json-converter-Repo-00CC66?style=for-the-badge&logo=github&logoColor=black)](https://github.com/VarshuAi/csv-to-json-converter)
